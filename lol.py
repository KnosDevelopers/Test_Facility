...
f= open("C:\\Users\\AMMAR\\Desktop\\testacoda.txt","r",encoding="utf-8")
text = f.read()
print(text)
z=input("Press Y to start game")
while (z.lower()=="y"):
    while True:
    ...
    #TOSS CODE:
        ...
        while True:
            toss = input("\nEnter your choice, press h for heads and t for tails: ")
            toss.lower()
            if(toss=='h' or toss=='t'):
                break
            else:
        ...
        if(bat_first==0):
            while True:
                ...
                print("Computer chose ",option_comp)
                if(option==option_comp):
                    print("\nComputer is out, total was",total_comp)
            ...
            while True:
                ...
                print("Computer chose ",option_comp)
                if(option==option_comp):
                    print("\nYou are out, your total was",total)
                    break
                total+=option
                if(total>total_comp):
        ...
        x=input("Press N to end the game and any other key to play again:  ")
        if(x.lower()=='n'):
            break
